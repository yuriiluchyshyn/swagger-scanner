...
function EndpointRow({
  ...
  globalParams, mergedValues, availableParams,
      ...
      <div className={`ep-collapse ${expanded ? 'ep-collapse-open' : ''}`}>
        <div>
          <EndpointDetail
            ...
            epParamOverrides={epParamOverrides[key]}
            ...
            onParamOverride={(name, val) => onParamOverride(key, name, val)}
            onParamOverrideReset={name => onParamOverrideReset(key, name)}
...
export default function EndpointList({
  ...
  globalParams, globalValues, availableParams,
  ...
  const rowProps = {
    epPayloads, epPathParams, epPathOverrides, epResponses, epParamOverrides,
    onExecute, onGeneratePayload, onGeneratePathParams, onSaveRequest,
    onPayloadChange, onPathOverride, onPathOverrideReset, onClearResponse,
    onUpdateGlobalParam, onParamOverride, onParamOverrideReset,
